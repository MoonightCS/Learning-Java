...
2. Для этого внутри методов castToHasHeight и getWidth создай локальные классы — реализации интерфейсов.
3. Переименуй castToHasHeight в castToHasHeight, getWidth в castToHasWidth (на имени метода нажми Shift+F6).
